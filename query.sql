...
select
    ...
    min(round(price_basic*k*@route_length)) as price_from, 
...
from 
    ...
    inner join v_marshrut_sostav_info as mc on (tr.id_marshrut = mc.id_marshrut and trs.vagon_ord_num = mc.vagon_ord_num and trs.seat_num = mc.seat_num)
where 
